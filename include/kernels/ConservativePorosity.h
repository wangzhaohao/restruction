 ...
 */
class ConservativePorosity : public Kernel
{
public:
  static InputParameters validParams();

  ConservativePorosity(const InputParameters & parameters);
